...
const array1 = inventors.filter(item => item.year >= 1500 && item.year <= 1600)
...
const array2 = inventors.map(item=>`${item.first} ${item.last}`)
console.log(array2)
console.log("---------------------------------------------------------------------")
...
const array4 = inventors.reduce((total, inventor) => {
  return total + (inventor.passed - inventor.year)
}, 0)

console.log(`${array4} anos`)
console.log("---------------------------------------------------------------------")

// 5. Sort the inventors by years lived
console.log("5. Sort the inventors by years lived")
const array5 = inventors.sort((a,b)=>{
  const primeiro = a.passed - a.year
  const proximo = b.passed - b.year
  return primeiro > proximo ? 1 : -1
})
console.log(array5)
console.log("---------------------------------------------------------------------")
